...
public class CodeImgUtil {
    ...
    private static BufferedImage genBarcode(String content,
                                            int width,
                                            int height,
     ...
     * @throws IOException
     */
    private static BufferedImage scale(String srcImageFile,
                                       int height,
                                       int width,
     ...
     * @throws IOException
     */
    public static String codeImgEncode(String filePath,
                                       String fileName,
                                       String info,
                                       int width,
    ...
    public static void writeQrCode(OutputStream stream,
                                   String info,
                                   int width,
                                   int height) throws WriterException, IOException {
        String format = "png";
