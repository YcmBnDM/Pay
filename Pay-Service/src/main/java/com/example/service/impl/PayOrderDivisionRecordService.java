...
import com.example.service.mapper.PayOrderDivisionRecordMapper;
import com.example.service.mapper.PayOrderMapper;
...
public class PayOrderDivisionRecordService extends ServiceImpl<PayOrderDivisionRecordMapper, PayOrderDivisionRecord> {
    ...
    public void updateResendState(String payOrderId){
        ...
        updateRecordByDiv.setBatchOrderId(SequenceUtil.genDivisionBatchId()); // 重新生成batchOrderId, 避免部分失败导致： out_trade_no重复。
