...
import com.example.pay.channel.IRefundService;
...
import com.example.pay.rqrs.resp.refund.RefundOrderRS;
...
public class RefundOrderController extends ApiController {
    ...
    public ApiRes refundOrder() {
        ...
        try {
            ...
            if (StringUtils.isNotEmpty(rq.getNotifyUrl()) && !StringUtil.isAvailableUrl(rq.getNotifyUrl())) {
    ...
    private RefundOrder genRefundOrder(RefundOrderRQ rq, PayOrder payOrder, MchInfo mchInfo, MchApp mchApp) {
        ...
        refundOrder.setRefundOrderId(SequenceUtil.genRefundOrderId()); //退款订单号
