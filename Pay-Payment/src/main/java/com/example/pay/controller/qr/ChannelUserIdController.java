...
import com.example.pay.rqrs.ChannelUserIdRQ;
...
public class ChannelUserIdController extends AbstractPayOrderController {
    ...
    public void jump() throws Exception {
        ...
        if(!StringUtil.isAvailableUrl(rq.getRedirectUrl())){
    ...
    public void oauth2Callback(@PathVariable("aesData") String aesData) throws Exception {
        ...
        JSONObject callbackData = JSON.parseObject(PayUtil.aesDecode(aesData));
        ...
        response.sendRedirect(StringUtil.appendUrlQuery(redirectUrl, appendParams));
    }
