...
import com.example.pay.channel.ITransferService;
...
import com.example.pay.rqrs.req.transfer.TransferOrderRQ;
import com.example.pay.rqrs.resp.transfer.TransferOrderRS;
...
public class TransferOrderController extends ApiController {
    ...
    private TransferOrder genTransferOrder(TransferOrderRQ rq, MchInfo mchInfo, MchApp mchApp, String ifCode){
        ...
        transferOrder.setTransferId(SequenceUtil.genTransferId()); //生成转账订单号
