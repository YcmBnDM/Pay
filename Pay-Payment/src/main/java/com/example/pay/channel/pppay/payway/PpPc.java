package com.example.pay.channel.pppay.payway;

import cn.hutool.json.JSONUtil;
import com.example.entity.PayOrder;
import com.example.pay.channel.pppay.PppayPaymentService;
import com.example.pay.model.MchAppConfigContext;
import com.example.pay.model.PaypalWrapper;
...
import com.example.pay.rqrs.req.payorder.payway.paypal.PPPcOrderRQ;
import com.example.pay.rqrs.resp.payorder.payway.paypal.PPPcOrderRS;
...
public class PpPc extends PppayPaymentService {
    ...
    public AbstractRS pay(UnifiedOrderRQ rq, PayOrder payOrder, MchAppConfigContext mchAppConfigContext) throws
        ...
        // 金额换算
        String amountStr = AmountUtil.convertCentToDollar(payOrder.getAmount().toString());
